...
public class mainExceptions extends Exception{
    ...
    public static String LerNome() throws IOException{
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não introduza algarismos no seu nome.");
        }
        return s;
    }
    
    public static int LerIdade() throws IOException{
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não introduza letras na sua idade.");
        }
        return i;
    }
    
    public static int LerIDSala() throws IOException{
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "O ID da sala so tem algarismos");
        }
    ...
    public static void criar_sala(SpotiParty.Sala sala , ArrayList<String> m,ArrayList<SpotiParty.UserNormal> Membros,ArrayList<SpotiParty.Musica> musicas,int j ){
        String s="";
    ...
    public static SpotiParty.UserNormal get_user(String nome, ArrayList<SpotiParty.UserNormal> lista){
        boolean encontrou = false;
        for(int i = 0;i < lista.size() ; i++){
            if(lista.get(i).getNome() == nome){
                return lista.get(i);
    ...
    public static void main(String[] args) {
      ...
      while(escolheu == 0){
       ...
       if(escolha == 3 ){
            guest = true;
           //Cria um guest
            SpotiParty.User current_guest = new SpotiParty.User("guest");
